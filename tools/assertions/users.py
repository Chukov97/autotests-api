...
def assert_get_user_response(get_user_response: GetUserResponseSchema, create_user_response: CreateUserResponseSchema):
    """
    Проверяет, что данные пользователя в ответе на get запрос совпадают с данными при создании.

    :param get_user_response: Ответ на запрос получения пользователя.
